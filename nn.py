...
data_X = training_dataset.loc[:, ['length', 'area', 'height', 'width',
...
testdata_X = test_dataset.loc[:, ['length', 'area', 'height', 'width',
                                 'average_direction', 'standart_deviation', 'curvature']].values
...
cross_entropy = cross_entropy + b * regularizers
...
test_accuracy = sess.run(accuracy, feed_dict={X: testdata_X, Y: testdata_Y})#, keep_prob: 1.0})
